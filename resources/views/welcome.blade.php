                            ...
                            <div class="widget-content">
                                <div class="account-box">
                                    ...
                                    <div class="info-box">
                                        <div class="icon">
                    <span>
                        <img src="{{ asset('/theme/cork') }}/laravel/build/assets/money-bag.ada7b966.png"
                             alt="money-bag">
                    </span>
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-five">
                            ...
                            <div class="widget-heading">
                                ...
                                <div class="task-action">
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" id="taskaction"
                                           data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                 viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                 stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <div class="dropdown-menu left" aria-labelledby="taskaction"
                                             style="will-change: transform;">
                                ...
                                <div class="meta-info">
                                    ...
                                    <div class="avatar--group">
                                        ...
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar"
                                                 src="{{asset('/theme/cork')}}/laravel/build/assets/profile-16.91b2a660.jpg"/>
                                        </div>
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar"
                                                 src="{{asset('/theme/cork')}}/laravel/build/assets/profile-16.91b2a660.jpg"/>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{ asset('/theme/cork') }}/laravel/build/assets/g-8.de42ec31.png"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body">
