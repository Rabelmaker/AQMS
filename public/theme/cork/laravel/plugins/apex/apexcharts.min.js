    ...
    var A = {
        ...
        return r(t, [{
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, o) {
                var n = this.w, l = s, h = new f(this.ctx), c = new x(this.ctx), d = new L(this.ctx),
                    g = new P(this.ctx), u = new b(this.ctx), p = g.getMarkerConfig({
        ...
        return r(t, [{
            ...
            key: "getColumnPaths", value: function (t) {
                ...
                var u = {barWidth: e, strokeWidth: o, yRatio: a, barXPosition: i, y1: s, y2: r},
                    p = this.getRoundedBars(d, u, n, h, c), f = i, x = i + e, v = g.move(f, s), m = g.move(f, s),
                    y = g.line(x - o, s);
        ...
        return r(t, [{
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, o = t.pathFrom, n = t.pathTo,
                    ...
                    f = t.barHeight, v = t.barWidth, m = t.barYPosition, y = t.elDataLabelsWrap, w = t.elGoalsMarkers,
        ...
        return r(t, [{
            ...
            key: "exportToCSV", value: function (t) {
                var e = this, i = t.series, a = t.columnDelimiter, s = t.lineDelimiter, r = void 0 === s ? "\n" : s,
                    o = this.w, n = [], l = [], h = "", c = new O(this.ctx), d = new B(this.ctx), g = function (t) {
                        var i = "";
        ...
        return r(t, [{
            ...
            key: "setYScaleForIndex", value: function (t, e, i) {
                ...
                var o = Math.abs(i - e);
                if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i, r.logBase); else if (i !== -Number.MAX_VALUE && p.isNumber(i)) if (a.allSeriesCollapsed = !1, void 0 === r.min && void 0 === r.max || r.forceNiceScale) {
        ...
        return r(t, [{
            key: "drawXCrosshairs", value: function () {
                var t = this.w, e = new b(this.ctx), i = new x(this.ctx), a = t.config.xaxis.crosshairs.fill.gradient,
                    ...
                    u = s.top, f = s.blur, v = s.color, m = s.opacity, y = t.config.xaxis.crosshairs.fill.color;
        ...
        return r(t, [{
            key: "getNearestValues", value: function (t) {
                ...
                var f = Math.round(g / h), x = Math.floor(u / c);
                ...
                if (y = y.map((function (t) {
                    ...
                    var k = this.ttCtx.getElGrid().getBoundingClientRect(), A = g * (k.width / n),
                        S = u * (k.height / l);
        ...
        return r(s, [{
            key: "draw", value: function (t, i) {
                var a = this, s = this.w, r = new b(this.ctx), o = new L(this.ctx);
                ...
                for (var l = r.group({class: "apexcharts-".concat(s.config.chart.type, "-series apexcharts-plot-series")}), h = function (n) {
                    ...
                    var h, c, d, g, u = void 0, f = void 0, x = [], b = [], v = s.globals.comboCharts ? i[n] : n,
                        m = r.group({
                            class: "apexcharts-series",
            ...
            key: "drawHorizontalBoxPaths", value: function (t) {
                ...
                var i = t.y, a = t.yDivision, s = t.barHeight, r = t.zeroW, o = t.strokeWidth, n = this.w,
                    l = new b(this.ctx), h = e.i, c = e.j, d = this.boxOptions.colors.lower;
                ...
                var k = l.move(r, w), A = l.move(v, w + s / 2);
        ...
        return r(t, [{
            ...
            key: "_createPaths", value: function (t) {
                var e = t.series, i = t.i, a = t.realIndex, s = t.j, r = t.x, o = t.y, n = t.pX, l = t.pY,
                    ...
                    f = new b(this.ctx), x = p.config.stroke.curve, v = this.areaBottomY;
        ...
        return r(t, [{
            key: "calculateTimeScaleTicks", value: function (t, i) {
                ...
                var n = r.getTimeUnitsfromTimestamp(t, i, this.utc), l = s.globals.gridWidth / o, h = l / 24,
                    c = h / 60, d = c / 60, g = Math.floor(24 * o), u = Math.floor(1440 * o), p = Math.floor(o * zt),
        ...
        return r(t, [{
            ...
            key: "_updateSeries", value: function (t, e) {
                ...
                return new Promise((function (s) {
                    ...
                    }))).length && (r = [{data: []}]), o.config.series = r) : o.config.series = t.slice(), a && (o.globals.initialSeries = p.clone(o.config.series)), i.ctx.update().then((function () {
                        s(i.ctx)
                    }))
                }))
            }
                ...
                return new Promise((function (e, i) {
                    if (null !== t.el) {
                        ...
                        if ("function" == typeof a && a(t, t.w), t.events.fireEvent("beforeMount", [t, t.w]), window.addEventListener("resize", t.windowResizeHandler), h = t.el.parentNode, c = t.parentResizeHandler, d = !1, g = new ResizeObserver((function (t) {
                            ...
                            var s = t.el.getRootNode && t.el.getRootNode(), r = p.is("ShadowRoot", s),
